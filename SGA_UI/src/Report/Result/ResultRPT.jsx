                                            ...
                                            <div className='dtdEndE'>
                                                <div style={{ display: 'flex', fontFamily: 'calibri Light', fontSize: '12px' }}>
                                                    <RadioWrapper>
                                                        ...
                                                        <RadioLabel htmlFor="SUMMARY">Summary</RadioLabel>
                                                    </RadioWrapper>
                                                    <RadioWrapper>
                                                        <HiddenRadio
                                                            id="MANAGER"
                                                ...
                                                <table ref={tableRef} className="grid-tableMainRes" id="tableExport">
                                                    <thead>
                                                        <tr>
                                                            ...
                                                            {STC_SEARCH.P_TYPE_REPORT !== 'SUMMARY' ? <th style={{ width: '300px' }} rowspan='2' align='left'>Category</th> : null}
                                                            ...
                                                            {/* Category มี if type <> 'SUMMARY'*/}
                                                            {STC_SEARCH.P_TYPE_REPORT !== 'SUMMARY' ? <th style={{ width: '250px' }} rowspan='2' align='left'>{STC_SEARCH.P_TYPE === 'MANAGER' ? 'Manager' : 'Member'}</th> : null}
                                                    ...
                                                    <tbody>
                                                        {dataList.map((row) => (
                                                            <tr>
                                                                ...
                                                                {/* Category มี if type <> 'SUMMARY'*/}
                                                                {STC_SEARCH.P_TYPE_REPORT !== 'SUMMARY' ? <td align='left'>{row.sga_category}</td> : null}
                                                                ...
                                                                {/* Category มี if type <> 'SUMMARY'*/}
                                                                {STC_SEARCH.P_TYPE_REPORT !== 'SUMMARY' ? <td align='left'>{row.emp_name}</td> : null}
